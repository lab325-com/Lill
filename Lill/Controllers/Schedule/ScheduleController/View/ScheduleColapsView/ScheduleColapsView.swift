...
class ScheduleColapsView: UIView, LoadFromXibProtocol {
    ...
    func updateView(model: GardenPlantByMainIdsModel, showCare: Bool) {
        ...
        careButton.setTitle(model.customIsDone == true ? RLocalization.scheldure_done.localized(PreferencesManager.sharedManager.languageCode.rawValue) : RLocalization.scheldure_care.localized(PreferencesManager.sharedManager.languageCode.rawValue), for: .normal)
