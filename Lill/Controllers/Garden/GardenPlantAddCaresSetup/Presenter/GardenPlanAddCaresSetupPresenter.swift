...
class GardenPlanAddCaresSetupPresenter: GardenPlanAddCaresSetupPresenterProtocol {
    ...
    func addCares(gardenPlantId: String, cares: [CaresModel]) {
        ...
        for care in cares {
            ...
            let record = GardenPlantCareCreateInput(gardenPlantId: gardenPlantId, name: care.name, count: care.count, period: care.period, careTypeId: careTypeId, sendNotificationAt: care.getTime)
