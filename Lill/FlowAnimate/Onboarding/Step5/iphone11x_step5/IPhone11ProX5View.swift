...
//@IBDesignable
public class IPhone11ProX5View: UIView {
    ...
    private func createPhone() {
        phone = UIView(frame: CGRect(x: 66, y: 739, width: 243, height: 491.7))
        ...
        phone.layer.position = CGPoint(x: 66, y: 739)
    ...
    private func createTxt() {
        txt = UIView(frame: CGRect(x: 142.58, y: 103.89, width: 196.7, height: 34.9))
        ...
        txt.layer.position = CGPoint(x: 142.58, y: 103.89)
    ...
    private func createCheck() {
        check = UIView(frame: CGRect(x: 390, y: 352, width: 97.5, height: 30))
        ...
        check.layer.position = CGPoint(x: 390, y: 352)
    ...
    private func createExecute() {
        execute = UIView(frame: CGRect(x: 398, y: 411, width: 97.5, height: 30))
        ...
        execute.layer.position = CGPoint(x: 398, y: 411)
    ...
    private func createRectangle4671() {
        ...
        rectangle467_1.shapeLayer.path = CGPathCreateWithSVGString("M0,15c0,-8.284,6.716,-15,15,-15l67.5,0c8.284,0,15,6.716,15,15 0,8.284,-6.716,15,-15,15l-67.5,0c-8.284,0,-15,-6.716,-15,-15l0,0zM0,15")!
