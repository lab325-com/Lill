...
//@IBDesignable
public class IPhone83View: UIView {
    ...
    private func createPhone() {
        phone = UIView(frame: CGRect(x: 66, y: 607, width: 243, height: 491.7))
        ...
        phone.layer.position = CGPoint(x: 66, y: 607)
    ...
    private func createPopupbiggreat1() {
        popupbiggreat1 = ShapeView(frame: CGRect(x: 385, y: 398, width: 150, height: 181))
        ...
        popupbiggreat1.layer.position = CGPoint(x: 385, y: 398)
    ...
    private func createAdd() {
        add = UIView(frame: CGRect(x: 390, y: 349, width: 80.83, height: 30))
        ...
        add.layer.position = CGPoint(x: 390, y: 349)
    ...
    private func createTxt() {
        txt = UIView(frame: CGRect(x: 159.74, y: 90, width: 164.16, height: 13.12))
        ...
        txt.layer.position = CGPoint(x: 159.74, y: 90)
