...
//@IBDesignable
public class IPhone13ProMax3View: UIView {
    ...
    private func createPhone() {
        phone = UIView(frame: CGRect(x: 76, y: 920, width: 276.76, height: 560))
        ...
        phone.layer.position = CGPoint(x: 76, y: 920)
    ...
    private func createAdd() {
        add = UIView(frame: CGRect(x: 452, y: 468, width: 80.83, height: 30))
        ...
        add.layer.position = CGPoint(x: 452, y: 468)
    ...
    private func createPopupbiggreat1() {
        popupbiggreat1 = ShapeView(frame: CGRect(x: 432, y: 521, width: 182, height: 220))
        ...
        popupbiggreat1.layer.position = CGPoint(x: 432, y: 521)
        popupbiggreat1.layer.bounds = CGRect(x: 0, y: 0, width: 182, height: 220)
        ...
        mask.path = CGPathCreateWithSVGString("M0,0l182,0 0,220 -182,0 0,-220zM0,0")!
        ...
        popupbiggreat1.shapeLayer.path = CGPathCreateWithSVGString("M0,0l182,0 0,220 -182,0 0,-220zM0,0")!
    ...
    private func createTxt() {
        txt = UIView(frame: CGRect(x: 182.06, y: 125, width: 173.28, height: 13.85))
        ...
        txt.layer.position = CGPoint(x: 182.06, y: 125)
        txt.layer.bounds = CGRect(x: 0, y: 0, width: 173.28, height: 13.85)
        txt.layer.masksToBounds = false

    }

    private func createAddPlantsInGarden() {
        addPlantsInGarden = ShapeView(frame: CGRect(x: 0, y: 0, width: 173.28, height: 13.85))
        ...
        addPlantsInGarden.layer.bounds = CGRect(x: 0, y: 0, width: 173.28, height: 13.85)
        ...
        addPlantsInGarden.shapeLayer.path = CGPathCreateWithSVGString("M0,13.618l2.18,0 1.234,-3.618 5.158,0 1.225,3.618 2.18,0 -4.861,-13.386 -2.245,0 -4.871,13.386 0,0zM5.975,2.449l0.037,0 1.995,5.881 -4.036,0 2.004,-5.881 0,0zM16.606,13.813c1.401,0,2.477,-0.705,3.062,-1.846l0.037,0 0,1.651 2.013,0 0,-13.386 -2.013,0 0,5.288 -0.037,0c-0.584,-1.15,-1.698,-1.846,-3.08,-1.846 -2.449,0,-4.063,1.948,-4.063,5.056l0,0.009c0,3.108,1.596,5.074,4.082,5.074l0,0zM17.135,12.087c-1.586,0,-2.561,-1.271,-2.561,-3.349l0,-0.009c0,-2.059,0.983,-3.34,2.561,-3.34 1.503,0,2.579,1.317,2.579,3.34l0,0.009c0,2.032,-1.067,3.349,-2.579,3.349l0,0zM27.423,13.813c1.401,0,2.477,-0.705,3.062,-1.846l0.037,0 0,1.651 2.013,0 0,-13.386 -2.013,0 0,5.288 -0.037,0c-0.584,-1.15,-1.698,-1.846,-3.08,-1.846 -2.449,0,-4.063,1.948,-4.063,5.056l0,0.009c0,3.108,1.596,5.074,4.082,5.074l0,0zM27.952,12.087c-1.586,0,-2.56,-1.271,-2.56,-3.349l0,-0.009c0,-2.059,0.983,-3.34,2.56,-3.34 1.503,0,2.579,1.317,2.579,3.34l0,0.009c0,2.032,-1.067,3.349,-2.579,3.349l0,0zM38.695,13.618l2.078,0 0,-4.573 2.904,0c2.625,0,4.444,-1.79,4.444,-4.406l0,-0.019c0,-2.625,-1.818,-4.388,-4.444,-4.388l-4.982,0 0,13.386 0,0zM43.158,1.985c