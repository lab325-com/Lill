...
//@IBDesignable
public class IPhone11ProX3View: UIView {
    public struct Defaults {
        public static let size = CGSize(width: 375, height: 812)
    ...
    private func createPhone() {
        phone = UIView(frame: CGRect(x: 66, y: 732, width: 243, height: 491.7))
        ...
        phone.layer.position = CGPoint(x: 66, y: 732)
    ...
    private func createGrad() {
        grad = ShapeView(frame: CGRect(x: 0, y: 451, width: 375, height: 361))
        ...
        grad.layer.position = CGPoint(x: 0, y: 451)
        grad.layer.bounds = CGRect(x: 0, y: 0, width: 375, height: 361)
        ...
        grad.shapeLayer.path = CGPathCreateWithSVGString("M0,0l375,0 0,361 -375,0 0,-361zM0,0")!
    ...
    private func createPopupbiggreat1() {
        popupbiggreat1 = ShapeView(frame: CGRect(x: 387, y: 452, width: 150, height: 181))
        ...
        popupbiggreat1.layer.position = CGPoint(x: 387, y: 452)
    ...
    private func createAdd() {
        add = UIView(frame: CGRect(x: 389, y: 403, width: 80.83, height: 30))
        ...
        add.layer.position = CGPoint(x: 389, y: 403)
    ...
    private func createLiLl() {
        liLl = UIView(frame: CGRect(x: 27, y: 66, width: 324, height: 102.5))
        ...
        liLl.layer.position = CGPoint(x: 27, y: 66)
    ...
    private func createTxt() {
        txt = UIView(frame: CGRect(x: 159.74, y: 114, width: 164.16, height: 13.12))
        ...
        txt.layer.position = CGPoint(x: 159.74, y: 114)
        txt.layer.bounds = CGRect(x: 0, y: 0, width: 164.16, height: 13.12)
        txt.layer.masksToBounds = false

    }

    private func createAddPlantsInGarden() {
        addPlantsInGarden = ShapeView(frame: CGRect(x: 0, y: 0, width: 164.16, height: 13.12))
        ...
        addPlantsInGarden.layer.bounds = CGRect(x: 0, y: 0, width: 164.16, height: 13.12)
        ...
        addPlantsInGarden.shapeLayer.path = CGPathCreateWithSVGString("M0,12.9l2.065,0 1.169,-3.427 4.887,0 1.16,3.427 2.065,0 -4.605,-12.681 -2.127,0 -4.614,12.681 0,0zM5.66,2.32l0.035,0 1.89,5.571 -3.823,0 1.898,-5.571 0,0zM15.732,13.085c1.327,0,2.347,-0.668,2.9,-1.749l0.035,0 0,1.564 1.907,0 0,-12.681 -1.907,0 0,5.009 -0.035,0c-0.554,-1.09,-1.608,-1.749,-2.918,-1.749 -2.32,0,-3.85,1.845,-3.85,4.789l0,0.009c0,2.944,1.512,4.807,3.867,4.807l0,0zM16.233,11.45c-1.503,0,-2.426,-1.204,-2.426,-3.172l0,-0.009c0,-1.951,0.932,-3.164,2.426,-3.164 1.424,0,2.443,1.248,2.443,3.164l0,0.009c0,1.925,-1.011,3.172,-2.443,3.172l0,0zM25.98,13.085c1.327,0,2.347,-0.668,2.9,-1.749l0.035,0 0,1.564 1.907,0 0,-12.681 -1.907,0 0,5.009 -0.035,0c-0.554,-1.09,-1.608,-1.749,-2.918,-1.749 -2.32,0,-3.85,1.845,-3.85,4.789l0,0.009c0,2.944,1.512,4.807,3.867,4.807l0,0zM26.481,11.45c-1.503,0,-
,1.107,-1.881,1.107 -1.31,0,-2.127,-0.879,-2.154,-2.381l6.487,0 0,-0.791c0,-2.847,-1.732,-4.719,-4.492,-4.719 -2.759,0,-4.526,1.916,-4.526,4.912l0,0.009c0,3.014,1.749,4.886,4.632,4.886l0,0zM149.64,5.202c1.064,0,1.829,0.677,1.987,1.977l-3.999,0c0.167,-1.274,0.958,-1.977,2.012,-1.977l0,0zM155.415,12.9l2.566,0 0,-5.413c0,-1.23,0.73,-2.074,1.881,-2.074 1.151,0,1.732,0.703,1.732,1.933l0,5.554 2.566,0 0,-6.081c0,-2.206,-1.178,-3.533,-3.252,-3.533 -1.424,0,-2.391,0.659,-2.874,1.74l-0.053,0 0,-1.547 -2.566,0 0,9.42 0,0zM155.415,12.9")!
    ...
    private func createGroup8() {
        group8 = UIView(frame: CGRect(x: 1.67, y: 0, width: 239.65, height: 491.7))
        ...
        group8.layer.position = CGPoint(x: 1.67, y: 0)
    ...
    private func createRectangle20() {
        ...
        rectangle20.shapeLayer.path = CGPathCreateWithSVGString("M0,52.018c0,-18.208,0,-27.312,3.543,-34.267 3.117,-6.117,8.09,-11.091,14.208,-14.208 6.954,-3.544,16.058,-3.544,34.266,-3.544l130.245,0c18.208,0,27.312,0,34.266,3.544 6.118,3.117,11.091,8.091,14.208,14.208 3.544,6.955,3.544,16.059,3.544,34.267l0,382.293c0,18.208,0,27.312,-3.544,34.267 -3.117,6.118,-8.09,11.091,-14.208,14.208 -6.954,3.544,-16.059,3.544,-34.266,3.544l-130.245,0c-18.208,0,-27.312,0,-34.266,-3.544 -6.117,-3.117,-11.091,-8.09,-14.208,-14.208 -3.543,-6.955,-3.543,-16.059,-3.543,-34.267l0,-382.293 0,0zM0,52.018")!
    ...
    private func createRectangle10() {
        ...
        rectangle10Mask.path = CGPathCreateWithSVGString("M0,55.773c0,-19.522,0,-29.284,3.799,-36.74 3.342,-6.559,8.675,-11.892,15.234,-15.234 7.457,-3.799,17.218,-3.799,36.74,-3.799l128.104,0c19.522,0,29.283,0,36.74,3.799 6.559,3.342,11.891,8.675,15.233,15.234 3.8,7.457,3.8,17.218,3.8,36.74l0,380.154c0,19.522,0,29.283,-3.8,36.74 -3.342,6.559,-8.674,11.891,-15.233,15.233 -7.457,3.8,-17.218,3.8,-36.74,3.8l-128.104,0c-19.522,0,-29.284,0,-36.74,-3.8 -6.559,-3.342,-11.892,-8.674,-15.234,-15.233 -3.799,-7.457,-3.799,-17.218,-3.799,-36.74l0,-380.154 0,0zM0,55.773")!
    ...
    private func createRectangle11() {
        ...
        rectangle11.shapeLayer.path = CGPathCreateWithSVGString("M0,55.773c0,-19.522,0,-29.284,3.799,-36.74 3.342,-6.559,8.675,-11.892,15.234,-15.234 7.457,-3.799,17.218,-3.799,36.74,-3.799l128.104,0c19.522,0,29.283,0,36.74,3.799 6.559,3.342,11.891,8.675,15.233,15.234 3.8,7.457,3.8,17.218,3.8,36.74l0,380.154c0,19.522,0,29.283,-3.8,36.74 -3.342,6.559,-8.674,11.891,-15.233,15.233 -7.457,3.8,-17.218,3.8,-36.74,3.8l-128.104,0c-19.522,0,-29.284,0,-36.74,-3.8 -6.559,-3.342,-11.892,-8.674,-15.234,-15.233 -3.799,-7.457,-3.799,-17.218,-3.799,-36.74l0,-380.154 0,0zM0,55.773")!
    ...
    private func createGroup81() {
        group8_1 = UIView(frame: CGRect(x: 1.67, y: 0, width: 239.65, height: 491.7))
        ...
        group8_1.layer.position = CGPoint(x: 1.67, y: 0)
    ...
    private func createRectangle201() {
        ...
        rectangle20_1.shapeLayer.path = CGPathCreateWithSVGString("M0,52.018c0,-18.208,0,-27.312,3.543,-34.267 3.117,-6.117,8.09,-11.091,14.208,-14.208 6.954,-3.544,16.058,-3.544,34.266,-3.544l130.245,0c18.208,0,27.312,0,34.266,3.544 6.118,3.117,11.091,8.091,14.208,14.208 3.544,6.955,3.544,16.059,3.544,34.267l0,382.293c0,18.208,0,27.312,-3.544,34.267 -3.117,6.118,-8.09,11.091,-14.208,14.208 -6.954,3.544,-16.059,3.544,-34.266,3.544l-130.245,0c-18.208,0,-27.312,0,-34.266,-3.544 -6.117,-3.117,-11.091,-8.09,-14.208,-14.208 -3.543,-6.955,-3.543,-16.059,-3.543,-34.267l0,-382.293 0,0zM0,52.018")!
    ...
    private func createRectangle101() {
        ...
        rectangle10_1Mask.path = CGPathCreateWithSVGString("M0,55.773c0,-19.522,0,-29.284,3.799,-36.74 3.342,-6.559,8.675,-11.892,15.234,-15.234 7.457,-3.799,17.218,-3.799,36.74,-3.799l128.104,0c19.522,0,29.283,0,36.74,3.799 6.559,3.342,11.891,8.675,15.233,15.234 3.8,7.457,3.8,17.218,3.8,36.74l0,380.154c0,19.522,0,29.283,-3.8,36.74 -3.342,6.559,-8.674,11.891,-15.233,15.233 -7.457,3.8,-17.218,3.8,-36.74,3.8l-128.104,0c-19.522,0,-29.284,0,-36.74,-3.8 -6.559,-3.342,-11.892,-8.674,-15.234,-15.233 -3.799,-7.457,-3.799,-17.218,-3.799,-36.74l0,-380.154 0,0zM0,55.773")!
    ...
    private func createRectangle111() {
        ...
        rectangle11_1.shapeLayer.path = CGPathCreateWithSVGString("M0,55.773c0,-19.522,0,-29.284,3.799,-36.74 3.342,-6.559,8.675,-11.892,15.234,-15.234 7.457,-3.799,17.218,-3.799,36.74,-3.799l128.104,0c19.522,0,29.283,0,36.74,3.799 6.559,3.342,11.891,8.675,15.233,15.234 3.8,7.457,3.8,17.218,3.8,36.74l0,380.154c0,19.522,0,29.283,-3.8,36.74 -3.342,6.559,-8.674,11.891,-15.233,15.233 -7.457,3.8,-17.218,3.8,-36.74,3.8l-128.104,0c-19.522,0,-29.284,0,-36.74,-3.8 -6.559,-3.342,-11.892,-8.674,-15.234,-15.233 -3.799,-7.457,-3.799,-17.218,-3.799,-36.74l0,-380.154 0,0zM0,55.773")!
