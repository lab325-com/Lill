...
//@IBDesignable
public class IPhone11ProX2View: UIView {
    ...
    private func createLill() {
        lill = UIView(frame: CGRect(x: 27, y: 66, width: 324, height: 101.02))
    ...
    private func createIphone480k() {
        iphone480k = ShapeView(frame: CGRect(x: 66, y: 750, width: 243, height: 491))
        ...
        iphone480k.layer.position = CGPoint(x: 66, y: 750)
    ...
    private func createCataloge() {
        cataloge = UIView(frame: CGRect(x: 399, y: 536, width: 125.83, height: 30))
        ...
        cataloge.layer.position = CGPoint(x: 399, y: 536)
    ...
    private func createPhoto() {
        photo = UIView(frame: CGRect(x: -129, y: 339, width: 100.83, height: 30))
        ...
        photo.layer.position = CGPoint(x: -129, y: 339)
    ...
    private func createName() {
        name = UIView(frame: CGRect(x: 392, y: 246, width: 95.83, height: 30))
        ...
        name.layer.position = CGPoint(x: 392, y: 246)
    ...
    private func createTxt() {
        txt = UIView(frame: CGRect(x: 187, y: 112, width: 114.13, height: 16))
        ...
        txt.layer.position = CGPoint(x: 187, y: 112)
        txt.layer.bounds = CGRect(x: 0, y: 0, width: 114.13, height: 16)
        txt.layer.masksToBounds = false

    }

    private func createExplorePlants() {
        explorePlants = ShapeView(frame: CGRect(x: 0, y: 0, width: 114.13, height: 16))
        ...
        explorePlants.layer.bounds = CGRect(x: 0, y: 0, width: 114.13, height: 16)
        ...
        explorePlants.shapeLayer.path = CGPathCreateWithSVGString("M0,12.877l8.509,0 0,-1.722 -6.428,0 0,-3.998 6.085,0 0,-1.678 -6.085,0 0,-3.757 6.428,0 0,-1.722 -8.509,0 0,12.877 0,0zM9.67,12.877l2.174,0 2.164,-3.453 0.046,0 2.164,3.453 2.211,0 -3.177,-4.747 3.214,-4.64 -2.22,0 -2.099,3.4 -0.046,0 -2.127,-3.4 -2.257,0 3.186,4.703 -3.233,4.685 0,0zM19.731,16l2.007,0 0,-4.703 0.046,0c0.576,1.089,1.7,1.767,3.084,1.767 2.452,0,4.059,-1.883,4.059,-4.872l0,-0.009c0,-2.998,-1.598,-4.872,-4.087,-4.872 -1.393,0,-2.471,0.678,-3.056,1.794l-0.046,0 0,-1.615 -2.007,0 0,12.511 0,0zM24.32,11.404c-1.514,0,-2.592,-1.267,-2.592,-3.213l0,-0.009c0,-1.954,1.068,-3.221,2.592,-3.221 1.57,0,2.564,1.223,2.564,3.221l0,0.009c0,1.981,-0.985,3.213,-2.564,3.213l0,0zM30.562,12.877l2.007,0 0,-12.877 -2.007,0 0,12.877 0,0zM38.83,13.064c2.796,0,4.635,-1.856,4.635,-4.881l0,-0.018c0,-3.007,-1.858,-4.854,-4.645,-4.854 -2.778,0,-4.626,1.856,-4.626,4.854l0,0.018c0,3.016,1.83,4.881,4.635,4.881l0,0zM38.839,11.449c-1.57,0,-2.592,-1.187,-2.592,-3.266l0,-0.018c0,-2.052,1.031,-3.239,2.573,-3.239 1.57,0,2.592,1.187,2.592,3.239l0,0.018c0,2.07,-1.003,3.266,-2.573,3.266l0,0zM45.017,12.877l2.007,0 0,-5.595c0,-1.401,0.799,-2.213,2.09,-2.213 0.39,0,0.743,0.045,0.901,0.107l0,-1.794c-0.158,-0.027,-0.409,-0.071,-0.697,-0.071 -1.115,0,-1.932,0.687,-2.248,1.785l-0.046,0 0,-1.606 -2.007,0 0,9.388 0,0zM55.003,13.064c2.369,0,3.874,-1.356,4.19,-2.847l0.019,-0.098 -1.904,0 -0.028,0.071c-0.251,0.705,-1.04,1.294,-2.229,1.294 -1.598,0,-