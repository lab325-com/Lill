...
//@IBDesignable
public class IPhoneSe4View: UIView {
    ...
    private func createPhone() {
        phone = UIView(frame: CGRect(x: 56, y: 539, width: 208, height: 420.88))
        ...
        phone.layer.position = CGPoint(x: 56, y: 539)
    ...
    private func createPopupbigstepwater1() {
        popupbigstepwater1 = ShapeView(frame: CGRect(x: 10, y: 547, width: 301, height: 135))
        ...
        popupbigstepwater1.layer.position = CGPoint(x: 10, y: 547)
    ...
    private func createGroup673() {
        group673 = UIView(frame: CGRect(x: 14, y: 32, width: 290, height: 91.74))
        group673.backgroundColor = UIColor.clear
        group673.layer.anchorPoint = CGPoint(x: 0, y: 0)
        group673.layer.shadowOffset = CGSize(width: 0, height: 0)
        group673.layer.borderWidth = 1
        group673.layer.borderColor = UIColor.clear.cgColor
        group673.layer.name = "group673"
        group673.layer.shadowColor = UIColor.clear.cgColor
        group673.layer.shadowOpacity = 1
        group673.layer.position = CGPoint(x: 14, y: 32)
        group673.layer.bounds = CGRect(x: 0, y: 0, width: 290, height: 91.74)
        group673.layer.masksToBounds = false

    }

    private func createSet() {
        set = UIView(frame: CGRect(x: 335, y: 221, width: 80.83, height: 30))
        ...
        set.layer.position = CGPoint(x: 335, y: 221)
    ...
    private func createVector116stroke() {
        vector116stroke = ShapeView(frame: CGRect(x: 24.32, y: 11.82, width: 8.02, height: 12.5))
        vector116stroke.backgroundColor = UIColor.clear
        vector116stroke.layer.anchorPoint = CGPoint(x: 0, y: 0)
        vector116stroke.transform = CGAffineTransform(rotationAngle: 0.5 * CGFloat.pi)
        ...
        vector116stroke.layer.position = CGPoint(x: 24.32, y: 11.82)
    ...
    private func createTxt() {
        txt = UIView(frame: CGRect(x: 111.88, y: 41.17, width: 156.89, height: 14.3))
        ...
        txt.layer.position = CGPoint(x: 111.88, y: 41.17)
        txt.layer.bounds = CGRect(x: 0, y: 0, width: 156.89, height: 14.3)
        txt.layer.masksToBounds = false

    }

    private func createSetupCaresInGarden() {
        setupCaresInGarden = ShapeView(frame: CGRect(x: 0, y: 0, width: 156.89, height: 14.3))
        ...
        setupCaresInGarden.layer.bounds = CGRect(x: 0, y: 0, width: 156.89, height: 14.3)
        ...
        setupCaresInGarden.shapeLayer.path = CGPathCreateWithSVGString("M4.382,11.736c2.69,0,4.327,-1.314,4.327,-3.382l0,-0.008c0,-1.754,-1.007,-2.706,-3.351,-3.201l-1.243,-0.26c-1.416,-0.307,-2.061,-0.826,-2.061,-1.675l0,-0.008c0,-0.991,0.897,-1.66,2.305,-1.668 1.345,0,2.258,0.637,2.415,1.691l0.008,0.11 1.715,0 -0.008,-0.134c-0.118,-1.904,-1.739,-3.194,-4.106,-3.194 -2.399,0,-4.106,1.329,-4.114,3.264l0,0.008c0,1.683,1.078,2.706,3.304,3.178l1.235,0.26c1.503,0.33,2.124,0.826,2.124,1.738l0,0.008c0,1.062,-0.96,1.746,-2.478,1.746 -1.518,0,-2.564,-0.653,-2.722,-1.699l-0.016,-0.102 -1.715,0 0.008,0.118c0.142,1.998,1.825,3.209,4.374,3.209l0,0zM13.625,11.712c2.006,0,3.28,-1.196,3.548,-2.509l0.016,-0.087 -1.613,0 -0.024,0.063c-0.212,0.621,-0.881,1.141,-1.888,1.141 -1.353,0,-2.21,-0.912,-2.242,-2.478l5.
719c0,-1.227,0.661,-1.904,1.793,-1.904 0.331,0,0.646,0.047,0.834,0.126l0,-2.022c-0.173,-0.047,-0.409,-0.087,-0.66,-0.087 -0.984,0,-1.668,0.606,-1.92,1.644l-0.047,0 0,-1.471 -2.297,0 0,8.432 0,0zM133.636,11.72c1.22,0,2.148,-0.614,2.596,-1.612l0.047,0 0,1.439 2.298,0 0,-11.35 -2.298,0 0,4.381 -0.047,0c-0.456,-1.023,-1.4,-1.636,-2.596,-1.636 -2.124,0,-3.43,1.636,-3.43,4.381l0,0.008c0,2.737,1.306,4.389,3.43,4.389l0,0zM134.407,9.817c-1.148,0,-1.864,-0.952,-1.864,-2.486l0,-0.008c0,-1.542,0.724,-2.478,1.864,-2.478 1.109,0,1.88,0.96,1.88,2.478l0,0.008c0,1.526,-0.763,2.486,-1.88,2.486l0,0zM143.95,11.72c2.407,0,3.571,-1.424,3.831,-2.666l0.023,-0.087 -2.108,0 -0.016,0.047c-0.165,0.472,-0.739,0.991,-1.683,0.991 -1.172,0,-1.904,-0.787,-1.928,-2.132l5.806,0 0,-0.708c0,-2.549,-1.55,-4.224,-4.02,-4.224 -2.47,0,-4.051,1.715,-4.051,4.397l0,0.008c0,2.698,1.565,4.373,4.146,4.373l0,0zM143.894,4.657c0.952,0,1.637,0.606,1.778,1.77l-3.579,0c0.149,-1.141,0.857,-1.77,1.801,-1.77l0,0zM149.063,11.547l2.297,0 0,-4.845c0,-1.101,0.653,-1.856,1.684,-1.856 1.03,0,1.549,0.629,1.549,1.73l0,4.971 2.297,0 0,-5.443c0,-1.974,-1.054,-3.162,-2.91,-3.162 -1.275,0,-2.14,0.59,-2.573,1.557l-0.047,0 0,-1.384 -2.297,0 0,8.432 0,0zM149.063,11.547")!
    ...
    private func createVector99() {
        vector9 = ShapeView(frame: CGRect(x: 0, y: 34.77, width: 40.53, height: 22.89))
        ...
        vector9.layer.bounds = CGRect(x: 0, y: 0, width: 40.53, height: 22.89)
        ...
        vector9.shapeLayer.path = CGPathCreateWithSVGString("M0,22.89l33.987,-22.89 6.543,22.89 -40.53,0 0,0zM0,22.89")!
    ...
    private func createVector21() {
        ...
        vector_21.shapeLayer.path = CGPathCreateWithSVGString("M6.88,17.093c0,0,-0.241,0.322,-2.256,0.322 -0.822,0.054,-1.648,-0.035,-2.44,-0.264 -0.184,-8.193,-0.901,-17.158,-2.185,-17.079 1.229,-0.153,2.475,-0.058,3.667,0.279 0,0,2.014,9.751,3.213,16.743")!
    ...
    private func createMainscreenaboutsegment() {
        mainscreenaboutsegment = ShapeView(frame: CGRect(x: 0.08, y: 0.01, width: 184.89, height: 987.11))
        ...
        mainscreenaboutsegment.layer.position = CGPoint(x: 0.08, y: 0.01)
        mainscreenaboutsegment.layer.bounds = CGRect(x: 0, y: 0, width: 184.89, height: 987.11)
        ...
        let mask = CAShapeLayer()
        mask.path = CGPathCreateWithSVGString("M0,0l184.89,0 0,987.11 -184.89,0 0,-987.11zM0,0")!
        mask.fillColor = UIColor.black.cgColor
        ...
        mainscreenaboutsegment.shapeLayer.path = CGPathCreateWithSVGString("M0,0l184.89,0 0,987.11 -184.89,0 0,-987.11zM0,0")!
    ...
    private func addSubviews() {
        ...
        group673.addSubview(liLl)
        group673.addSubview(txt)
