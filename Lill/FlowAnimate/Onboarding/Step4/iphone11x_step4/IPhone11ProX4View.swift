...
//@IBDesignable
public class IPhone11ProX4View: UIView {
    ...
    private func createPhone() {
        phone = UIView(frame: CGRect(x: 66, y: 735, width: 243, height: 491.7))
        ...
        phone.layer.position = CGPoint(x: 66, y: 735)
    ...
    private func createPopupbigstepwater1() {
        popupbigstepwater1 = ShapeView(frame: CGRect(x: 37, y: 828, width: 301, height: 135))
        ...
        popupbigstepwater1.layer.position = CGPoint(x: 37, y: 828)
    ...
    private func createGrad() {
        grad = ShapeView(frame: CGRect(x: 0, y: 496, width: 375, height: 316))
        ...
        grad.layer.position = CGPoint(x: 0, y: 496)
        grad.layer.bounds = CGRect(x: 0, y: 0, width: 375, height: 316)
        ...
        grad.shapeLayer.path = CGPathCreateWithSVGString("M0,0l375,0 0,316 -375,0 0,-316zM0,0")!

        let startPoint = CGPoint(x: 0.5, y: 0.028)
        let endPoint = CGPoint(x: 0.5, y: 0.528)
    ...
    private func createTxt() {
        txt = UIView(frame: CGRect(x: 152, y: 113.73, width: 175.29, height: 15.98))
        ...
        txt.layer.position = CGPoint(x: 152, y: 113.73)
    ...
    private func createSet() {
        set = UIView(frame: CGRect(x: 388, y: 347, width: 80.83, height: 30))
        ...
        set.layer.position = CGPoint(x: 388, y: 347)
